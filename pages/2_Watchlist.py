...
for t in WATCHLIST:
    try:
        ...
        if not df.empty and len(df) >= 50:
            ...
            score = 50
            if len(close) >= 200 and curr_p > ema20.iloc[-1] > ema50.iloc[-1] > ema200.iloc[-1]:
                score += 20
            ...
            if avg_volume_20 * curr_p < 5000000:
                score -= 20

            disparity = ((curr_p - ema20.iloc[-1]) / ema20.iloc[-1]) * 100
            if disparity > 20:
                score -= 15
